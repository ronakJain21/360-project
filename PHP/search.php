...
<head>
    ...
    <link rel="stylesheet" href="../CSS/searchstyle-phone.css" media="screen and (max-width: 480px)">
    <link rel="stylesheet" href="../CSS/searchstyle.css" media="screen and (min-width: 769px)">
